...
public class OffFanState extends LowSpeedFanState {
	...
	protected long getFanSpeed() {
		return FanState.OFF_STATE.getFanSpeed();
	}
	...
	protected String getTitle() {
		return FanState.OFF_STATE.prettyPrint();
	}
	...
	protected String getId() {
		return FanState.OFF_STATE.toString();
	}
}
