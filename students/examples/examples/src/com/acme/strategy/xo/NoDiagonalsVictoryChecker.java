...
/**
 * An implementation of a victory checker which excludes diagonals.
 */
public class NoDiagonalsVictoryChecker implements VictoryChecker {

	/**
	 * Checks if the game was won.
	 *
	 * @param board the board 9 board array.
