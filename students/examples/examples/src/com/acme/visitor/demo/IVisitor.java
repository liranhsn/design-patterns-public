...
/**
 * The interface IVisitor defines the contract for a visitor implementation
 */
public interface IVisitor {
	...
	default void visit(Object object) {
		try {
			Method downPolymorphic = object.getClass().getMethod("visit", new Class[] { object.getClass() });
